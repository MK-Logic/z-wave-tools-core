...
{
    public partial class COMMAND_CLASS_ZIP_V4
    {
        ...
        public partial class COMMAND_ZIP_PACKET
        {
            ...
            public ByteValue headerLength = 0;
            ...
            public static implicit operator COMMAND_ZIP_PACKET(byte[] data)
            {
                ...
                if (data != null)
                {
                    ...
                    {
                        ret.headerLength = data.Length > index ? (ByteValue)data[index++] : ByteValue.Empty;
                    }
                    if (ret.properties2.headerExtIncluded > 0)
                    {
            ...
            public static implicit operator byte[](COMMAND_ZIP_PACKET command)
            {
                ...
                {
                    if (command.headerLength.HasValue) ret.Add(command.headerLength);
                }
                if (command.properties2.headerExtIncluded > 0)
                {
        ...
        public partial class COMMAND_ZIP_KEEP_ALIVE
        {
