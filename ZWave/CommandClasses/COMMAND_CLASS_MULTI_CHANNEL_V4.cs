...
{
    public partial class COMMAND_CLASS_MULTI_CHANNEL_V4
    {
        ...
        public partial class MULTI_INSTANCE_GET
        {
            ...
            public static implicit operator byte[](MULTI_INSTANCE_GET command)
            {
                ...
                ret.Add(COMMAND_CLASS_MULTI_CHANNEL_V4.ID);
                ret.Add(ID);
        ...
        public partial class MULTI_CHANNEL_AGGREGATED_MEMBERS_GET
        {
            ...
            public Tproperties1 properties1 = 0;
            public static implicit operator MULTI_CHANNEL_AGGREGATED_MEMBERS_GET(byte[] data)
            {
                MULTI_CHANNEL_AGGREGATED_MEMBERS_GET ret = new MULTI_CHANNEL_AGGREGATED_MEMBERS_GET();
                if (data != null)
                {
                    int index = 2;
                    ret.properties1 = data.Length > index ? (Tproperties1)data[index++] : Tproperties1.Empty;
            ...
            public static implicit operator byte[](MULTI_CHANNEL_AGGREGATED_MEMBERS_GET command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_MULTI_CHANNEL_V4.ID);
                ret.Add(ID);
        ...
        public partial class MULTI_CHANNEL_AGGREGATED_MEMBERS_REPORT
        {
            ...
            public IList<byte> aggregatedMembersBitMask = new List<byte>();
            public static implicit operator MULTI_CHANNEL_AGGREGATED_MEMBERS_REPORT(byte[] data)
            {
                MULTI_CHANNEL_AGGREGATED_MEMBERS_REPORT ret = new MULTI_CHANNEL_AGGREGATED_MEMBERS_REPORT();
                if (data != null)
                {
                    int index = 2;
                    ret.properties1 = data.Length > index ? (Tproperties1)data[index++] : Tproperties1.Empty;
                    ret.numberOfBitMasks = data.Length > index ? (ByteValue)data[index++] : ByteValue.Empty;
                    ret.aggregatedMembersBitMask = new List<byte>();
                    for (int i = 0; i < ret.numberOfBitMasks; i++)
                    {
                        if (data.Length > index) ret.aggregatedMembersBitMask.Add(data[index++]);
                    }
                }
                return ret;
            }
            public static implicit operator byte[](MULTI_CHANNEL_AGGREGATED_MEMBERS_REPORT command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_MULTI_CHANNEL_V4.ID);
                ret.Add(ID);
                ...
                if (command.aggregatedMembersBitMask != null)
                {
                    foreach (var tmp in command.aggregatedMembersBitMask)
                    {
                        ret.Add(tmp);
                    }
                }
