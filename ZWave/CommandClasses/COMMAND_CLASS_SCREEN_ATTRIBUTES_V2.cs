...
{
    public partial class COMMAND_CLASS_SCREEN_ATTRIBUTES_V2
    {
        ...
        public partial class SCREEN_ATTRIBUTES_REPORT
        {
            ...
            public ByteValue screenTimeout = 0;
            public static implicit operator SCREEN_ATTRIBUTES_REPORT(byte[] data)
            {
                ...
                if (data != null)
                {
                    ...
                    ret.screenTimeout = data.Length > index ? (ByteValue)data[index++] : ByteValue.Empty;
                }
                return ret;
            }
            public static implicit operator byte[](SCREEN_ATTRIBUTES_REPORT command)
            {
                ...
                if (command.screenTimeout.HasValue) ret.Add(command.screenTimeout);
                return ret.ToArray();
            }
        }
        public partial class SCREEN_ATTRIBUTES_REPORT_LEGACY
        {
