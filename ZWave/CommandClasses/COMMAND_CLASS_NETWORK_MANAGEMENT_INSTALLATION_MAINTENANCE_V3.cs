...
{
    public partial class COMMAND_CLASS_NETWORK_MANAGEMENT_INSTALLATION_MAINTENANCE_V3
    {
        ...
        public partial class PRIORITY_ROUTE_SET
        {
            ...
            public static implicit operator byte[](PRIORITY_ROUTE_SET command)
            {
                ...
                ret.Add(COMMAND_CLASS_NETWORK_MANAGEMENT_INSTALLATION_MAINTENANCE_V3.ID);
                ret.Add(ID);
