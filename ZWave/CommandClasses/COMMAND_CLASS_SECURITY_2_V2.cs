...
{
    public partial class COMMAND_CLASS_SECURITY_2_V2
    {
        ...
        public partial class NLS_NODE_LIST_REPORT
        {
            ...
            public static implicit operator byte[](NLS_NODE_LIST_REPORT command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_SECURITY_2_V2.ID);
                ret.Add(ID);
        ...
        public partial class NLS_STATE_GET
        {
            public const byte ID = 0x11;
            public static implicit operator NLS_STATE_GET(byte[] data)
            {
                NLS_STATE_GET ret = new NLS_STATE_GET();
                return ret;
            }
            public static implicit operator byte[](NLS_STATE_GET command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_SECURITY_2_V2.ID);
                ret.Add(ID);
        ...
        public partial class NLS_STATE_REPORT
        {
            ...
            public Tproperties1 properties1 = 0;
            public static implicit operator NLS_STATE_REPORT(byte[] data)
            {
                NLS_STATE_REPORT ret = new NLS_STATE_REPORT();
                if (data != null)
                {
                    int index = 2;
                    ret.properties1 = data.Length > index ? (Tproperties1)data[index++] : Tproperties1.Empty;
            ...
            public static implicit operator byte[](NLS_STATE_REPORT command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_SECURITY_2_V2.ID);
                ret.Add(ID);
        ...
        public partial class NLS_STATE_SET
        {
            public const byte ID = 0x13;
            public ByteValue nlsState = 0;
            public static implicit operator NLS_STATE_SET(byte[] data)
            {
                NLS_STATE_SET ret = new NLS_STATE_SET();
                if (data != null)
                {
                    int index = 2;
                    ret.nlsState = data.Length > index ? (ByteValue)data[index++] : ByteValue.Empty;
                }
                return ret;
            }
            public static implicit operator byte[](NLS_STATE_SET command)
            {
                List<byte> ret = new List<byte>();
                ret.Add(COMMAND_CLASS_SECURITY_2_V2.ID);
                ret.Add(ID);
                if (command.nlsState.HasValue) ret.Add(command.nlsState);
                return ret.ToArray();
            }
        }
    }
